...
class ControlEnv:
    ...
    def step(self, action):
        ...
        # info already contains collision information from bddl_base_domain
    ...
    def get_collision_count(self):
        """Get the current collision count with danger zones."""
        if hasattr(self.env, 'danger_zone_manager'):
            return self.env.danger_zone_manager.get_collision_count()
        return 0
    
    def get_danger_zone_info(self):
        """Get detailed danger zone information."""
        if hasattr(self.env, 'danger_zone_manager'):
            return self.env.danger_zone_manager.get_full_info()
        return {
            'num_danger_zones': 0,
            'collision_count': 0,
