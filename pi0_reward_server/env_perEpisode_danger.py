...
def eval_one_task(args: Args) -> None:
    ...
    try:
        ...
        logging.info(f"=== Start evaluating ONE task in DANGER mode ===")
        ...
        try:
            ...
            while t < max_steps + args.num_steps_wait:
                ...
                if t < args.num_steps_wait:
                    ...
                    # logging.info(f"Step {t}: reward={reward}, done={done}, info={info}")
                    # 在等待阶段也检查碰撞
        ...
        return success_rate, episode_collision_count
...
def _get_libero_env(task, resolution, seed):
    ...
    # logging.info(f"task_bddl_file: {task_bddl_file}")
