...
def get_libero_env(task, model_family=None, resolution=256):
...
def save_rollout_video(save_folder,rollout_images, idx, success, task_description, log_file=None):
    """Saves an MP4 replay of an episode."""
    rollout_dir = f"./{save_folder}/{DATE}"
