...
HF_REPO_NAME = "libero-init-frames"          # 数据集仓库名
TASK_LIST = [
    # 'libero_spatial', 
    # 'libero_object', 
    # 'libero_goal', 
...
LOCAL_SAVE_DIR = "./libero-init-frames"
OUTPUT_JSON = "libero-init-frames/json_data_for_rl/vlm_initial_state_links.json"
# =====================================
...
def main():
    ...
    for task_name in task_name_list:
        ...
        for task_id in tqdm(range(num_tasks_in_suite)):
            ...
            per_suite_task_to_url[task_key] = [image_url]
